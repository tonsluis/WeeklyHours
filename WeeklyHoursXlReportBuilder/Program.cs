...
namespace WeeklyHoursXlReportBuilder
{
    ...
    class Program
    {
        ...
        {
            IList<int> myNegerIds = new List<int>();
            var reportSubjects = ConfigurationManager.GetSection("ReportSubjects") as ReportSubjects;
            foreach (Neger n in reportSubjects.Instances)
            {
                myNegerIds.Add(n.Id);
            }
            ...
            List<Worker> data = host.GetReportDataById(myNegerIds);
